...
class SaleTestAbas(BasicFlow):
    ...
    def sign_in(self):
        ...
        time.sleep(1)
        driver.execute_script(
            "$('button[type=submit]:contains(INICIAR SESIÓN)').click()")
    ...
    def close_session(self):
        ...
        time.sleep(2)
        driver.execute_script(
            "$('a.fa.o_menu_toggle.fa-th').click()")
        time.sleep(3)
    ...
    def fill_form(self):
        ...
        time.sleep(2)
        driver.execute_script(
            "$('td:contains(Cliente):not(:contains(Referencia))')."
    ...
    def go_to_website(self):
        """Method to move to website page
        """
        driver = self.driver
        time.sleep(3)
        driver.execute_script(
    ...
    def add_cart(self):
        ...
        time.sleep(2)
        driver.execute_script(
            "$('span.fa.fa-shopping-cart').click()")
        time.sleep(1)
        driver.execute_script(
            "$('a span:contains(Continuar a caja)').click()")
        time.sleep(2)
        driver.execute_script(
    ...
    def fill_billing_form(self):
        ...
        time.sleep(1)
        driver.execute_script(
            "$('input[name=mobile]').val('9876543210')")
        time.sleep(1)
        driver.execute_script(
            "$('input[name=company_name]').val('Abastotal')")
        time.sleep(1)
        driver.execute_script(
            "$('input[name=vat]').val('XAXX010101000')")
        time.sleep(1)
        driver.execute_script(
            "$('input[name=street_name]').val('PRUEBA (cancelar cotización por favor)')")
        time.sleep(1)
        driver.execute_script(
            "$('input[name=street_number]').val('141')")
        time.sleep(1)
        driver.execute_script(
            "$('input[name=street_number2]').val('401')")
        time.sleep(1)
        driver.execute_script(
            "$('input[name=street2]').val('colonia')")
        time.sleep(1)
        driver.execute_script(
            "$('input[name=city]').val('ciudad')")
        time.sleep(1)
        driver.execute_script(
            "$('input[name=zip]').val('00000')")
        time.sleep(1)
        driver.execute_script(
            "$('select[name=state_id] option:contains(Colima)')."
            "prop('selected', true)")
        time.sleep(2)
        driver.execute_script(
            "$('a span:contains(Next)').click()")
    ...
    def select_payment(self):
        ...
        time.sleep(2)
        driver.execute_script(
            "$('li:contains(Transferencia Bancaria) input').click()")
        time.sleep(2)
        driver.execute_script(
            "$('form[action=\"/payment/transfer/feedback\"] "
            "button')[0].click()")
        time.sleep(10)
        driver.execute_script(
            "$('a.fa.fa-th').click()")
    ...
    def fill_shipping_form(self):
        ...
        time.sleep(2)
        driver.execute_script(
            "$('a:contains(Add an address)').click()")
        time.sleep(1)
        driver.execute_script(
            "$('input[name=name]').val('ejemplo')")
        time.sleep(1)
        driver.execute_script(
            "$('input[name=phone]').val('1472583690')")
        time.sleep(1)
        driver.execute_script(
            "$('input[name=street_name]').val('avenida')")
        time.sleep(1)
        driver.execute_script(
            "$('input[name=street_number]').val('456')")
        time.sleep(1)
        driver.execute_script(
            "$('input[name=street_number2]').val('7')")
        time.sleep(1)
        driver.execute_script(
            "$('input[name=street]').val('456/7 avenida')")
        time.sleep(1)
        driver.execute_script(
            "$('input[name=street2]').val('centro')")
        time.sleep(1)
        driver.execute_script(
            "$('input[name=city]').val('guadalajara')")
        time.sleep(1)
        driver.execute_script(
            "$('input[name=zip]').val('99999')")
        time.sleep(1)
        driver.execute_script(
            "$('select[name=state_id] option:contains(Jalisco)')."
            "prop('selected', true)")
        time.sleep(2)
        driver.execute_script(
            "$('a span:contains(Next)').click()")
    ...
    def fill_product_form(self):
        ...
        time.sleep(2)
        driver.execute_script(
            "$('select[name=type] option:contains(Almacenable)')"
            ".prop('selected', true)")
        time.sleep(2)
        driver.execute_script(
        ...
        time.sleep(2)
        driver.execute_script(
            "$('tr:contains(Cost) input').val('17.50')")
        time.sleep(2)
        driver.execute_script(
...
def main(server, user, password, db, com):
    ...
    methods = {
        'abastotal': ['sign_in', 'go_to_pos_form', 'fill_pos_form', 'close_session', 
                      'go_to_sale_form', 'fill_form',
                      'create_invoice', 'go_to_pickings', 'validate_out',
                      'go_to_website','add_cart', #'fill_billing_form',
                      'select_payment', 'go_to_sale_quotation', 'confirm_sale',
                      'create_invoice', 'go_to_pickings', 'validate_out',
